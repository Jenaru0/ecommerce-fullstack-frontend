<template>
  <section class="container mx-auto px-6 md:px-16 lg:px-24 py-16">
    <h2 class="text-3xl font-black text-center mb-10">NOVEDADES</h2>
    ...
    <div class="text-center mt-8">
      <NuxtLink
        ...
        class="text-sm font-medium inline-block hover:underline"
        >Ver Todos</NuxtLink
      >
    </div>
  </section>
